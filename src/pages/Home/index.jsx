            ...
            <nav className="relative flex items-center justify-between px-4 md:px-8 py-4 max-w-7xl mx-auto bg-white z-50">
                ...
                <div className="hidden md:flex items-center space-x-4">
                    <div className="flex space-x-8 mr-8">
                        <a  className="text-gray-600 hover:text-gray-900 transition-colors" onClick={()=>{  solutionsref.current?.scrollIntoView({ behavior: 'smooth' });
        setIsMobileMenuOpen(false);}}>Solutions</a>
                        <button 
                ...
                <div className="md:hidden relative">
                    ...
                    {isMobileMenuOpen && (
                        <div className="absolute top-full right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-2 z-50">
                            <a href="#solutions" className="block px-4 py-2 text-gray-600 hover:bg-gray-100">Solutions</a>
                            <button 
                                onClick={scrollToAbout}
           ...
           <div ref={aboutRef} id="about" className="max-w-6xl mx-auto px-4 md:px-8 mb-20 scroll-mt-20">
                   ...
                   {[
                       ...
                       <div key={index} className="text-center">
                           <img 
                               src={member.img}
                               alt={member.name}
                               className="w-48 h-48 mx-auto rounded-lg mb-6 object-cover shadow-md hover:shadow-xl transition-all duration-300"
                               loading="lazy"
                           />
